...
/**
 * MemberDayService 纯单元测试（不依赖数据库迁移）
 * 
 * Feature: member-privileges-upgrade
 */
class MemberDayServiceUnitTest extends TestCase
{
    ...
    public function property7_member_day_discount_by_level(
        ...
        Cache::put('member_day_config', $config, 3600);
     ...
     */
    #[Test]
    public function calculateDiscountedAmount_returns_correct_amount(): void
    {
        // Arrange
        $config = new MemberDayConfig([
            'day_of_month' => 8,
        ...
        // Act
        $discountedAmount = $this->sut->calculateDiscountedAmount(100.0, 'gold');

        // Assert
        $this->assertEquals(85.0, $discountedAmount); // 100 * 0.85 = 85
    }
}
