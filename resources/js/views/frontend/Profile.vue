...
const menus = [
  ...
  { key: 'privileges', label: '会员权益', icon: '👑', route: '/frontend/privileges' },
  { key: 'mall', label: '积分商城', icon: '🛒', route: '/frontend/mall' },
  { key: 'redemptions', label: '兑换记录', icon: '📋', route: '/frontend/redemptions' },
